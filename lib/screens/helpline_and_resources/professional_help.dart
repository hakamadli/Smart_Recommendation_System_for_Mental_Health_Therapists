...
import 'package:smart_recommendation_system_for_mental_health_patients/screens/helpline_and_resources/components/create.dart';
...
class _HelpPageState extends State<HelpPage> {
  ...
  Widget build(BuildContext context) {
    ...
    void editEntry(DocumentSnapshot resource) {
      Navigator.of(context)
          .push(
            MaterialPageRoute(
              builder: (context) => EditHelpPage(resource: resource),
            ),
          )
          .then((value) => Navigator.of(context).pop());
    }

    void showOptions(DocumentSnapshot resource, Color color) {
      showDialog(
        context: context,
        builder: (context) => AlertDialog(
          shape: RoundedRectangleBorder(
          ...
          content: Column(
            ...
            children: [
              ...
              TextButton.icon(
                onPressed: () {
                  showDeleteOptions(resource, color);
                },
                icon: const Icon(
                  Icons.delete,
                  color: myRed,
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: (() {
                          showOptions(helpData, myDarkPurple);
                        }),
                        child: Container(
                          margin:
